...
import { Utils, EdgePlane, Point } from '../core/utils';
...
export class HalfEdge {
  ...
  public plane: EdgePlane | null = null;
  ...
  public generatePlane() {
    ...
    function transformCorner(corner: Point) {
...
//  }
   ...
   */
  private halfAngleVector(v1: HalfEdge | null, v2: HalfEdge | null): Point {
